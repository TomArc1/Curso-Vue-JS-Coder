<template>
  <section id="app" class="w-full h-screen bg-[#2b2b2b]">
      ...
      <div class="flex items-start justify-evenly">
          ...
          <div v-for="(generacion, index) of generaciones" :key="index">
            <div class="flex flex-col items-center">
                <button @click="openClose()" class="inline-block border border-[#c4c4c4] py-5 px-10 mb-10 rounded-[2rem] text-white bg-[#3b3b3b]">Generación {{ index }}</button>
                <div >
                  <poke-list :generacion="generacion"></poke-list>
                </div>
            </div>
          </div>
          ...
          <!-- <div v-for="(generacion, index) of generaciones" :key="index">
            <div class="flex flex-col items-center">
                <button @click="openClose()" class="inline-block border border-[#c4c4c4] py-5 px-10 mb-10 rounded-[2rem] text-white bg-[#3b3b3b]">Generación</button>
                <poke-list v-show="this.open" :generacion="generacion"></poke-list>
            </div>
          </div> -->
